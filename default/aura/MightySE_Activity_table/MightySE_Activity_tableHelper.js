({
    geteventDataJS:function(component, event, startDate, endDate) {
        var action = component.get("c.getAllActivityData");
        action.setParams({
            'filterBy': component.get("v.filterByEvent"),
            startDate : startDate,	
            endDate : endDate
        });
        action.setStorable();
    ...
    buildData : function(component, event) {
        ...
        component.set("v.getAllActivityList", data);
