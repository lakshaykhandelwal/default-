({
    geteventDataJS : function(component, event, helper) {
        var now = new Date();
        ...
        helper.geteventDataJS(component, event , firstDate.toISOString().substr(0, 10), endDate.toISOString().substr(0, 10));
    },
    ...
    applyfilter : function(component, event, helper){
        helper.geteventDataJS(component, event);
    },
    ...
    incinputChanged:function(component, event, helper) {
        ...
        helper.geteventDataJS(component, event , startDate, endDate);
