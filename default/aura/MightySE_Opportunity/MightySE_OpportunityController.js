({
    getOpportunityDataJS : function(component, event, helper) {
        var now = new Date();
        ...
        helper.getOpportunityDataJS(component, event , firstDate.toISOString().substr(0, 10), endDate.toISOString().substr(0, 10));
    },
    
    SaveAccount : function(component, event, helper) {
        console.log("getAllActivityList"+ JSON.stringify(component.get("v.getAllOpportunityList")));
        var action = component.get("c.saveAccount");
        action.setParams({
            'listOfAccount': component.get("v.getAllOpportunityList")
        });
    ...
    filterDates:function(component,event,helper){
        ...
        helper.getOpportunityDataJS(component, event , startDate, endDate);
